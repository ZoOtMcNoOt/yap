...
const HEALTHY_BODY: &str = r#"{"service":"yap-server","status":"ok","apiVersion":"1","auth":"not_configured","capabilities":{"batchJobs":true,"liveStreaming":true,"jobStatus":true,"transcriptCorrection":true,"librarianQueries":true,"archivistIngestions":true,"studentQuestions":true,"curatorProposals":true,"analystAnswers":true,"coordinatorBundles":true}}"#;
