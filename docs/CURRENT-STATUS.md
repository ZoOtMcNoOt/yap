...
| Phase 7: identity/access | Active; qualified repair pending final admission/gate | The [tenant-scoped identity and job authorization plan](plans/active/2026-07-25-tenant-scoped-identity-and-job-authorization.md) governs the branch. Provider-neutral OIDC/Entra policy, tenant-scoped ownership, purpose authorization, protected readiness, authenticated bounded private WebSocket admission, and the native lower handshake execute under focused tests. The desktop still has no selected production token adapter. Exact head `944673071804d8178776efa1d1e13651c87df6fb` passed its private and complete matrix but was consumed when GitHub rejected its first workflow during parsing. Workflow repair `cafbe307e7203e09050fdbe2eb080d5d84b65026` is preserved after fresh target-client qualification exposed bounded local-ASR pre-roll saturation. Exact repair `32cf52891c277a4a3d47aa9fb3cab105ca58af98` passed focused verification, same-three review, 12 repeated resource sessions, nine prepared-audio boundaries, and the physical-microphone/rendered-UI lifecycle with zero drops; the first isolated scheduler-outlier attempt remains preserved as failed evidence. Documentation reconciliation is committed at `e019036184398833ebfd5fef25aa9e0148fadc49`. Final exact-tree closure and admission, one complete replacement matrix, exact-head hosted closure, and merge remain open. |
...
- Phase 7 candidates `134ec08002aeb1deca83547d511528b282966731`,
  ...
  `e019036...`. Final exact-tree closure and admission, the one replacement
  phase gate, first-valid-attempt hosted PR closure, and merge remain open.
