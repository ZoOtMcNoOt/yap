...
Exact candidate `8565145b5279ed009f4c0da4339de1d35e478b93` now implements
...
remote unavailability. Public portable checks are green: server
**1,513 = 1,466 passed + 47 declared skips**, desktop **59 files / 372 tests**
plus a **27/27** focused successor run, production build, Rust
**1,253 passed + 11 expected ignored**, strict Clippy, and focused boundary
checks. This is an executable candidate, not a qualified or merged product
surface: no new owner-private database/broker/identity/native/renderer gate,
hosted exact-head checks, review, or merge has occurred. The existing Librarian
core receipt is not product evidence. See the
...
only on exact unmerged candidate `8565145b...`; every other non-Scribe role
product surface remains pending.
