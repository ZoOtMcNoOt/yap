...
```text
 ...
 1173 LIVE                 server/src/yap_server/live/protocol.py ||   586 LIVE                 server/src/yap_server/live/websocket_server.py
  ...
  395 TEST-EVALUATION      server/tests/evaluation/promotion_registry_fixture.py ||   664 TEST-EVALUATION      server/tests/evaluation/test_agent_model_fixture_runner.py
