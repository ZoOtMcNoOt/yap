...
```text
 ...
 1154 CURRENT-DOC          docs/runbooks/yap-server-node-setup.md ||   554 CURRENT-DOC          docs/specs/source-aware-diarization.md
  ...
  414 AUTH                 server/src/yap_server/auth/oidc_metadata.py ||   453 EVALUATION           server/src/yap_server/evaluation/agent_model_acceptance.py
  427 EVALUATION           server/src/yap_server/evaluation/agent_model_fixture_runner.py ||   678 EVALUATION           server/src/yap_server/evaluation/agent_model_qualification.py
 ...
 1173 LIVE                 server/src/yap_server/live/protocol.py ||   586 LIVE                 server/src/yap_server/live/websocket_server.py
  ...
  395 TEST-EVALUATION      server/tests/evaluation/promotion_registry_fixture.py ||   581 TEST-EVALUATION      server/tests/evaluation/test_agent_model_fixture_runner.py
