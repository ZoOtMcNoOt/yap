...
| Post-Phase-9 checkpoint — active | Review knowledge, tool, model, permission, evidence, lifecycle, documentation, and human-maintainability boundaries without adding Phase 10 behavior. | Checkpoint gate, PR, and merge. |
