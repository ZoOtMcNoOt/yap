...
| Phase 9 — active candidate | Governed terminology, OKF compilation, permission-safe retrieval, agents/RAG/MCP, and privately qualified vLLM-backed Qwen rapid/Gemma complex workload routes. | One complete permission-isolated Python/Postgres/pgvector/restart/private-route gate, exact-head hosted review, focused PR, and merge. Production service integration remains Phase 10. |
