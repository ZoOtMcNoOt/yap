...
| D-03 | Serving split | Cohere batch uses vLLM, Nemotron retains a Transformers reference and evaluates NeMo for server streaming, SGLang is reserved for compatible agent/LLM reasoning and structured tool output, and Rust owns orchestration, admission, state, cancellation, and validation. Triton is retired from the current ASR plane. | Exact Phase 6 candidate `0ed2037dbbb8c3df9350dbc37aeddc633f567a40` passed candidate-safety evidence for vLLM and NeMo without promotion. Provider selection remains Phase 8, SGLang Phase 9, and production integration Phase 10. | ADR 0025, roadmap |
...
receipt independently validated for the exact head and all 30 children; the
...
`0ed2037dbbb8c3df9350dbc37aeddc633f567a40` subsequently passed the complete
30-child matrix, all 18 GB10 provider children, the target-client and connected
channels, and exact teardown on 2026-07-25. Its candidate receipt independently
validated for the exact head and all 30 children. Hosted closure, PR review,
