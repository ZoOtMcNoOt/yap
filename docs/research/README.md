...
| [Dynamic language detection evaluation](2026-07-16-dynamic-language-detection-evaluation.md) | Use explicit Nemotron segment-level auto mode as the Phase 6 candidate; benchmark Qwen and VibeVoice without claiming unreleased frame-level diarization |
