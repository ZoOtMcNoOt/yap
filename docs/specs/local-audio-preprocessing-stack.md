...
**Status:** Accepted design contract; desktop capture/timeline/recording foundation and the gated Phase 5 canonical-WAV path are merged. Historical Phase 6 candidate `c82fe47a683dabd72231ffca377095ff16f2d4f5` passed its complete local/private matrix after bounded three-agent remediation re-review, then a hosted-only executable timing correction invalidated it as merge authority. A fresh exact-head gate, hosted review, and merge remain.
