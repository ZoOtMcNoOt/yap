...
**Status:** Canonical Phase 3 boundary, isolated Phase 4 Cohere reference pool, and gated Phase 5 loopback durable batch path implemented. Phase 7 added fail-closed REST ownership and bounded authenticated private WebSocket admission; live ASR, a published client-facing WSS edge, and persistent production deployment remain pending.
