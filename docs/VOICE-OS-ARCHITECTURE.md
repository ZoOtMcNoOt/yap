...
qualification, aggregate governed, and hosted gates. Exact local head
`9b14beff...` adds bounded multi-user admission for already-warm services;
application workflows remain absent. The accepted performance topology is provider-specific: Cohere batch
...
profiles through PR #157 as `cac8989b...`. The bounded admission substrate is
the current local Slice 10.3 candidate; product workflows remain next.
Live ASR,
