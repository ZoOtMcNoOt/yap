...
Exact unmerged `8565145b...` adds a public-portable-green Librarian HTTP/native/
Knowledge candidate; its private product gate, hosted review, and merge remain
open. Auditor and the other remaining role product surfaces stay open. The
...
| **10** | Eight bounded role cores merged; Librarian product candidate unmerged | The merged baseline includes Scribe, Archivist, Student, Curator, Librarian, Analyst, Coordinator, and Auditor through PR #172. Exact unmerged `8565145b...` adds public-portable-green Librarian HTTP/native/Knowledge behavior but has no new private product receipt, hosted review, or merge. Remaining role product exposure, simultaneous residency, sustained capacity, observability, enterprise access, secure-edge promotion, publication governance, and repo split remain later slices or IT handoffs. |
...
Exact unmerged `8565145b...` adds Librarian product integration but remains
pending private qualification, hosted review, and merge. Archivist, Student,
Curator, Analyst, Coordinator, and Auditor product integration remains open. Coordinator
...
| **10** Enterprise/release | All eight bounded role cores are merged through PR #172. Exact unmerged `8565145b...` adds a public-portable-green Librarian HTTP/native/Knowledge candidate; its private product gate, hosted review, and merge remain open. Remaining role product exposure, second-node simultaneous full-profile residency, sustained mixed-load capacity promotion, observability, enterprise access, secure-edge evidence, packaging, and repo split remain open. | [ADRs 0030](adr/0030-rust-supervised-provider-service-lifecycle.md) and [0031](adr/0031-eight-agent-voice-os-roster.md), the active Phase 10/roster plans, the [Librarian product candidate record](evidence/librarian-product-vertical/VERIFICATION.md), route-specific sustained capacity/SLO evidence, CI/CD migration, and cross-repo link update. |
