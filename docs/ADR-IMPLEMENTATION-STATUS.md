...
| [0030](adr/0030-rust-supervised-provider-service-lifecycle.md) | Accepted Phase 10 lifecycle target; Slices 10.1 and 10.2 merged | Server | **100** | The merged hardware-independent baseline adds one Rust supervisor for one explicit foreground launcher, canonical numeric-loopback and exact single-model readiness, a fixed three-in-60-second child restart policy, process-group-complete bounded stop, owner-private state counters, a hardened systemd outer cgroup, a fail-closed installer, a feature-gated lifecycle fixture, and a dedicated exact-head Linux CI lane. Exact hosted-green head `1a487db8...` passed that lane plus every required CI and CodeQL check and merged through PR #155 as `e2d82b89...`. Slice 10.2 binds immutable Qwen/Gemma profiles to separate instances; exact lifecycle head `4b103c1b...` passed both sequential lifecycle/teardown paths with public-safe evidence SHA-256 `9b6a34f6...`, aggregate head `0471b158...` passed after fresh route qualification, and hosted-green head `6d1400cc...` merged through PR #157 as `cac8989b...`. Exact batch-invariant executable successor `0665c486...` reran both full profiles sequentially with lifecycle evidence SHA-256 `7cc016f4...`; lock-only `8fee7a5c...` publishes the newly qualified route lock. | No provider is enabled or promoted. Simultaneous warm residency, cross-start/global determinism, sustained mixed-owner capacity/p95/p99/fairness/overload/recovery evidence, observability, rollback, SBOM/notices, and IT-owned production deployment remain open. | Keep lifecycle authority separate from admission and workflows; do not infer capacity or production readiness from sequential evidence. |
| [0031](adr/0031-eight-agent-voice-os-roster.md) | Accepted complete Phase 10 roster and execution boundary; all eight bounded role cores merged through PR #172 | Shared | **50** | The exact eight-role map is frozen. Exact executable `08b06f6d...` qualified Auditor with public-safe evidence SHA-256 `2c1dbc05...`: three synchronized repeat waves matched 24/24 normals and all 29 terminals, including 12 server-derived noncanonical review-required reports with 15 potential-contradiction findings and 30 citations. Active and queued non-idle work blocked Auditor admission until terminal. Hosted head `937a4129...` passed all 12 required checks and PR #172 merged it as `1b255e9a...`, completing the internal roster. Exact `e2ba1864...` privately qualified Librarian's authenticated HTTP server boundary; hosted head `67a79ce2...` passed all 12 checks and PR #174 merged the HTTP/native/Knowledge vertical as `98af78c9...`. Exact `a2e9b551...` privately qualified Archivist's HTTP/native/renderer boundary with public-safe evidence SHA-256 `9ec9e373...`, 10/10 exact server-side terminals, zero activation, and exact teardown; hosted head `69215c43...` passed all 12 checks and PR #177 merged the vertical as `e397af8b...`. Exact `778a7545...` privately qualified Student's authenticated product server boundary with public-safe evidence SHA-256 `c46cf7df...` and 11/11 exact terminals; hosted head `53ce570b...` passed all 12 checks and PR #178 merged it as `6546970b...`. Exact `2dcecef4...` privately qualified Curator's authenticated product server boundary with public-safe evidence SHA-256 `bc24ee6b...` and 10/10 exact terminals. | Scribe, Librarian, Archivist, and Student are the four merged product surfaces. Curator has a privately qualified unmerged HTTP/native/renderer successor pending hosted review. Product private gates do not qualify native/renderer round trips or live enterprise identity-provider exchange. Analyst/Coordinator/Auditor remain internal-only. Same-warm-process repeatability is not cross-start/global determinism, simultaneous Qwen/Gemma residency, sustained capacity/fairness, a production SLO, or deployment evidence. | Preserve the bounded internal role contracts, complete Curator hosted review/merge without weakening Gemma's qualified route, then run the separate Muse decision gate and separately qualify/review Analyst, Coordinator, and Auditor product surfaces before enterprise gates. |
