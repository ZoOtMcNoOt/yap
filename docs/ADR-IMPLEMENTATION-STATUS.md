...
| [0031](adr/0031-eight-agent-voice-os-roster.md) | Accepted complete Phase 10 roster and execution boundary; three role cores merged; Curator/profile-capacity successor privately qualified under draft PR #168 | Shared | **50** | The exact eight-role purpose/route/class map is frozen. PR #158 merged the owner-fair bounded admission substrate; PR #164 merged Scribe, PR #165 merged Archivist, and PR #166 merged the internal Student core as `2254605e...`. Exact route head `dab19fe...` returned `required-workload-routes-qualified` with public-safe evidence SHA-256 `96228914...`, admitting Qwen and Gemma sequentially on unchanged full profiles with exact teardown. Exact workflow head `7cd24deb...` privately requalified Scribe and Student and returned `curator-knowledge-proposals-qualified` with public-safe evidence SHA-256 `b60df1e2...`: eight cases/eight owners, four proposals/four rejections, zero failures, complex eight/ninth queued, PostgreSQL lifecycle/read-back, and teardown. Exact aggregate/public-lock head `7f896b34...` returned `governed-knowledge-gate-passed` with public-safe evidence SHA-256 `fd197b98...`. | PR #168 remains draft: hosted review/merge and Student/Curator product exposure are not delivered. Auditor, Librarian, Analyst, and Coordinator remain unimplemented. Selected-route rapid-four/complex-eight evidence is not simultaneous Qwen/Gemma residency, sustained capacity/fairness, production SLO, or deployment evidence. One Spark cannot retain the unchanged `0.40` and `0.70` profiles simultaneously; a second owned GPU node/private route remains required. | Complete exact-head hosted review and merge for PR #168 without reusing historical receipts, then implement each later role as its own source/permission/persistence-bound workflow and admit the full-strength two-node topology before enterprise gates. |
