...
The current focused branch adds only local-first setup isolation and repeated,
consent-gated fixed-loopback discovery. It does not change any ADR score or
claim managed discovery, live ASR, production SSO, or an enterprise edge.
