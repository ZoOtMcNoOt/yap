...
candidate `0ed2037dbbb8c3df9350dbc37aeddc633f567a40` passed its frozen
...
three-agent adversarial re-review. This docs-only change reconciles the
evidence; exact-head hosted closure, PR review, and merge remain.
