...
CI and CodeQL jobs. Final documentation-only hosted closure, including
disposable-Windows NSIS, and PR #143 merge remain. Exact Phase 6
...
CodeQL jobs. This changes no ADR score or model/runtime qualification claim;
only the final documentation-only hosted closure and merge remain.
