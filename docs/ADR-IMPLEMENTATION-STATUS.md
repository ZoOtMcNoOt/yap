...
**As of:** 2026-07-16; Phases 3–5 and Architecture Checkpoint A are merged and their checked-head evidence remains recorded below. Phase 5 PR head `4771d9be60562fa009ccecbcd3c7111b699883a5` passed the one-time complete local/native/server/GB10 gate and hosted checks, then merged as `b6677631b2cc8283f0f6466622f2dfa7cfdb38f6`. Checkpoint implementation candidate `6d55816b0406a2365376d7b2d9a7da2afecf9118` passed its one-time complete matrix; final PR head `2dc1c48c31928106d07cc638828f055929c33e0c` passed hosted CI, CodeQL, and disposable-Windows NSIS, then merged as `a80934d844a068110e7f86b30b6e29d35146db57`. Phase 6 is active, but ADR 0024 currently has decision/benchmark evidence only and no implementation score.
...
| [0024](adr/0024-phase6-global-language-routing.md) | Accepted canonical Phase 6 language, provider, LID, and timing decision | Shared | **0** | Public aggregate candidate benchmarks and an active implementation/gate plan exist | No capability catalog, primary-language persistence/UX, VAD stage, LID component, Nemotron server pool/auto mode, aligned-word production, durable stage migration, or Phase 6 gate | Implement on `feat/phase6-preprocessing-pipeline`; update this score only after executable evidence exists |
