...
**Date:** 2026-07-16; amended 2026-07-25
...
CodeQL, and stock-NSIS passed at first attempt on final reviewed head
`50f0f9e5e3cf288f41efa3745514dd08c9ee1929`; its private closure receipt was
independently validated outside Git. PR #67 merged as
...
matrix passed at `a92f338546a2f8bbaded96b04f8987f0ac475c88`. This is not
...
INT8, FP16, or FP32 artifact that still passes its CPU and memory gate.
The current local Nemotron ASR remains the tested INT8 sherpa-onnx artifact.
Every future format must pass model-specific accuracy, representative low-end
physical CPU latency, resident-memory, battery/thermal, packaging, and rollback
evidence before default-on or production promotion.
...
5. [x] Replace the superseded SpeechBrain component with the verify-only
       ...
       `a92f338546a2f8bbaded96b04f8987f0ac475c88` consumed that component inside
...
7. [x] Finish release-safety evidence for the implemented `LiveRuntime`-owned,
       ...
       `a92f338546a2f8bbaded96b04f8987f0ac475c88` passed both current-host
...
13. [x] Run the complete Phase 6 local/native/server/private-runtime matrix
       ...
       `a92f338546a2f8bbaded96b04f8987f0ac475c88` passed all 30 children; retain
