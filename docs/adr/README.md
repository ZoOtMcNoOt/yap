...
| [0024](0024-global-language-routing.md) | Global language routing and timing evidence | Accepted decision; provider serving amended by [0025](0025-provider-specific-asr-serving.md) and batch preflight amended by [0026](0026-ambernet-batch-language-preflight.md); exact candidate `a92f338546a2f8bbaded96b04f8987f0ac475c88` passed the complete local/private matrix; hosted closure, final review, merge, and later promotion remain open |
