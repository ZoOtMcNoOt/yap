...
| [0024](0024-global-language-routing.md) | Global language routing and timing evidence | Accepted decision; provider serving amended by [0025](0025-provider-specific-asr-serving.md) and batch preflight amended by [0026](0026-ambernet-batch-language-preflight.md); exact candidate `0ed2037dbbb8c3df9350dbc37aeddc633f567a40` passed the complete local/private matrix; hosted closure and later promotion remain open |
| [0025](0025-provider-specific-asr-serving.md) | Provider-specific ASR serving runtimes | Accepted; Cohere vLLM, resident Nemotron NeMo, and all 18 candidate-safety children passed inside exact candidate `0ed2037dbbb8c3df9350dbc37aeddc633f567a40`; both services remain unpromoted and broad quality evidence stays open |
| [0026](0026-ambernet-batch-language-preflight.md) | AmberNet batch language preflight | Accepted; exact candidate `0ed2037dbbb8c3df9350dbc37aeddc633f567a40` passed the source-exact ARM64 lifecycle, connected route, and complete matrix; representative suggestion quality remains open |
