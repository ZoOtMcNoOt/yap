...
| [0025](0025-provider-specific-asr-serving.md) | Provider-specific ASR serving runtimes | Accepted; Cohere vLLM, resident Nemotron NeMo, bounded loopback proxy ownership, and sequential lifecycle-gate composition are implemented under focused tests; frozen GB10 execution and both promotion gates remain incomplete |
