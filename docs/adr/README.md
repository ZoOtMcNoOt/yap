...
| [0030](0030-rust-supervised-provider-service-lifecycle.md) | Rust-supervised provider service lifecycle | Accepted Phase 10 target; the unmerged Slice 10.1 candidate implements the hardware-independent systemd/Rust/foreground-launcher boundary and remains pending hosted Linux proof and merge; provider profiles, application integration, and capacity remain later slices |
