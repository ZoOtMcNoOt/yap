...
through PR #165. Student's evidence-index repair is complete-portable-test green;
replacement private qualification remains open after
exact `476f7a9c...` returned terminal `deterministic-no-student`. Warm simultaneous residency, the
