...
| [0024](0024-global-language-routing.md) | Global language routing and timing evidence | Accepted decision; provider serving amended by [0025](0025-provider-specific-asr-serving.md) and batch preflight amended by [0026](0026-ambernet-batch-language-preflight.md); historical candidate `97b63be46b05dffa21595f2fd081b8467bb95798` passed the complete matrix before final review invalidated it as merge authority; replacement gating and later promotion remain open |
| [0025](0025-provider-specific-asr-serving.md) | Provider-specific ASR serving runtimes | Accepted; Cohere vLLM, resident Nemotron NeMo, and all 18 candidate-safety children passed inside historical candidate `97b63be46b05dffa21595f2fd081b8467bb95798` before it was invalidated as merge authority; both services remain unpromoted and replacement/broad quality evidence stays open |
| [0026](0026-ambernet-batch-language-preflight.md) | AmberNet batch language preflight | Accepted; historical candidate `97b63be46b05dffa21595f2fd081b8467bb95798` passed the source-exact ARM64 lifecycle boundary before it was invalidated as merge authority; replacement gating and representative suggestion quality remain open |
