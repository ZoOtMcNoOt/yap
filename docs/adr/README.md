...
| [0024](0024-global-language-routing.md) | Global language routing and timing evidence | Accepted decision; provider serving amended by [0025](0025-provider-specific-asr-serving.md) and batch preflight amended by [0026](0026-ambernet-batch-language-preflight.md); exact candidate `cf9b5453270a8afa87cfca42206767a1bf7d82ee` passed the complete local/private matrix; hosted closure, final review, merge, and later promotion remain open |
| [0025](0025-provider-specific-asr-serving.md) | Provider-specific ASR serving runtimes | Accepted; Cohere vLLM, resident Nemotron NeMo, and all 18 candidate-safety children passed inside exact candidate `cf9b5453270a8afa87cfca42206767a1bf7d82ee`; both services remain unpromoted and broad quality evidence stays open |
| [0026](0026-ambernet-batch-language-preflight.md) | AmberNet batch language preflight | Accepted; exact candidate `cf9b5453270a8afa87cfca42206767a1bf7d82ee` passed the source-exact ARM64 lifecycle, connected route, and complete matrix; representative suggestion quality remains open |
