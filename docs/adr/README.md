...
| [0027](0027-tiron-joint-speaker-attributed-meeting-transcription.md) | Tiron joint speaker-attributed meeting transcription | Accepted Phase 8 explicit Preview baseline; exact runtime/Preview gate passed on `1c69b61...`, PR #142 merged as `4201c5e7...`, the separate maintainability checkpoint is active, and production promotion remains open |
