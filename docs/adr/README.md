...
| [0025](0025-provider-specific-asr-serving.md) | Provider-specific ASR serving runtimes | Accepted; Cohere vLLM, resident Nemotron NeMo, bounded loopback proxy ownership, and the sequential candidate-safety lifecycle passed at exact GB10 head `a21964c19e56648e9fddcb5200de419e59a7687c`; both services remain unpromoted and broad quality/replacement evidence stays in Phase 8 |
| [0026](0026-ambernet-batch-language-preflight.md) | AmberNet batch language preflight | Accepted; exact executable head `a21964c19e56648e9fddcb5200de419e59a7687c` passed the final source-exact ARM64 image/resource/lifecycle repetition; representative suggestion quality and the complete Phase 6 gate remain incomplete |
