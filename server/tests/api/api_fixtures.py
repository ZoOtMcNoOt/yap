...
class HealthServerTestCase(unittest.TestCase):
    ...
    analyst_answer_service: object | None = None
    coordinator_bundle_service: object | None = None
    auditor_report_service: object | None = None
    ...
    def setUp(self) -> None:
        ...
        self.server = create_server(
            ...
            analyst_answer_service=self.analyst_answer_service,
            coordinator_bundle_service=self.coordinator_bundle_service,
            auditor_report_service=self.auditor_report_service,
        ...
        if (
            ...
            and self.analyst_answer_service is None
            and self.coordinator_bundle_service is None
