...
from yap_server.pools.isolated_runtime_evidence import finalize_host_boundary_evidence
...
class IsolatedRuntimeEvidenceTests(unittest.TestCase):
    def test_publishes_only_after_host_boundary_is_observed_unchanged(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(observed["remainingGateContainers"], 0)
    ...
    def test_rejects_a_residual_gate_container_or_worker(self) -> None:
