...
class GovernedKnowledgeGateContractTests(unittest.TestCase):
    def test_repository_locks_are_strict_and_route_artifacts_are_frozen(self) -> None:
        ...
        self.assertEqual(
            ...
            "6d1400ccdf481333840700b51f516c813960272b",
        )
    ...
    def test_agent_route_drift_contract_covers_all_transitive_owners(self) -> None:
        protected = (
            ...
            "server/src/yap_server/evaluation/agent_service_lifecycle_gate.py",
            "server/src/yap_server/evaluation/agent_service_lifecycle_observation.py",
            "server/src/yap_server/evaluation/agent_service_lifecycle_runtime.py",
            ...
            "infra/yap-server-node/install-agent-admission-service.sh",
            "infra/yap-server-node/install-provider-supervisor-service.sh",
            "infra/yap-server-node/owned-process-group.sh",
            "infra/yap-server-node/owned-process-supervisor.py",
            "infra/yap-server-node/private-container-loopback-proxy.sh",
            "infra/yap-server-node/yap-agent-admission-broker.service.in",
            ...
            "server/orchestrator/src/agent_admission/owner_queue.rs",
            "server/orchestrator/src/agent_admission/priority.rs",
            "server/orchestrator/src/agent_admission/terminal.rs",
            "server/orchestrator/src/agent_admission/types.rs",
            "server/orchestrator/src/agent_admission_broker.rs",
            "server/orchestrator/src/agent_admission_config.rs",
            "server/orchestrator/src/agent_admission_protocol.rs",
            "server/orchestrator/src/agent_work.rs",
            "server/orchestrator/src/bin/yap-agent-admission-broker.rs",
            "server/orchestrator/src/bin/yap-supervised-service-fixture.rs",
            ...
            "server/orchestrator/src/main.rs",
            ...
            "server/orchestrator/tests/agent_admission_broker_contract.rs",
            "server/orchestrator/tests/agent_admission_command_line_contract.rs",
            "server/orchestrator/tests/agent_admission_contract.rs",
            "server/orchestrator/tests/agent_admission_failure_contract.rs",
            "server/orchestrator/tests/agent_admission_protocol_contract.rs",
            "server/orchestrator/tests/agent_work_contract.rs",
            "server/orchestrator/tests/command_line_contract.rs",
            ...
            "server/tests/evaluation/test_agent_service_lifecycle_gate.py",
            "server/tests/evaluation/test_agent_service_lifecycle_observation.py",
            "server/tests/evaluation/test_agent_service_lifecycle_runtime.py",
            ...
            "server/tests/infra/test_agent_admission_service.py",
            "server/tests/infra/test_agent_vllm_server.py",
            "server/tests/infra/test_owned_process_group_behavior.py",
            "server/tests/infra/test_owned_process_supervisor.py",
            "server/tests/infra/test_private_container_loopback_proxy.py",
            "server/tests/infra/test_private_container_loopback_proxy_behavior.py",
            "server/tests/infra/test_provider_supervisor_service.py",
